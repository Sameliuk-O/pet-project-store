  ...
  return (
    <div className=" container m-auto mt-24">
      <div className="flex items-center mobile:flex-col lg:flex-row">
        <img
          alt="orange tree"
          className="text-center mobile:hidden md:flex md:flex-1 "
          src={ORANGE_TREE}
        />
        <img
          alt="orange phone"
          ...
          src={ORANGE_PHONE}
        />
        <div className="flex-1 mobile:pb-118px mobile:text-center lg:pb-274px lg:pt-16 lg:text-right">
          ...
          <p className=" text-custom-16/32 font-medium text-text-grey-blue mobile:pb-30px mobile:pt-2 sm:pl-10 lg:pb-40px lg:pl-36 lg:pt-5">
